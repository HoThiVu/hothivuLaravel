								...
								<div class="col-sm-4">
									<div class="single-item" >
										<div class="single-item-header">
											<a href="product.html"><img src="/source/image/product/{{$sp ->image}}" alt="" style="widht:15r3m;height:15rem"></a>
										</div>
						...
						<div class="beta-products-list">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="single-item" >
										<div class="single-item-header">
											<a href="product.html"><img src="/source/image/product/{{$spk ->image}}" alt="" style="widht:15r3m;height:15rem"></a>
										</div>
										<div class="single-item-body">
