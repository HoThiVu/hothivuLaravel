        ...
        <div id="content">
            ...
            <form action="{{ route('checkout') }}" method="post" class="beta-form-checkout">
                ...
                <div class="row">
                                            ...
                                            @foreach ($productCarts as $product)
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <p class="font-large">{{ $product['item']['image'] }}</p>
                                                        <span class="color-gray your-order-info">Unit price:
                                                            {{ $product['item']['promotion_price'] == 0
                                                                ? number_format($product['item']['unit_price'])
                                                                : number_format($product['item']['promotion_price']) }}</span>
                    ...
                    {{-- @csrf --}}
                    <button class="beta-btn primary" type="submit" name="redirect" >Đặt hàng</button>
                    {{-- </form> --}}
