...
<body>
    ...
    <!-- jQuery -->
    <script src="/source/admin//source/admin/bower_components/jquery/dist/jquery.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="/source/admin//source/admin/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>

    <!-- Metis Menu Plugin JavaScript -->
    <script src="/source/admin//source/admin/bower_components/metisMenu/dist/metisMenu.min.js"></script>
